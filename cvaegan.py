...
def generator_loss(x_original, x_generated, features_original_disc, features_generated_disc,
    ...
    # l1_loss = K.mean((Flatten()(x_original) - Flatten()(x_generated)) * img_width * img_height)
    l2_loss = K.mean(mse(Flatten()(x_original), Flatten()(x_generated)) * img_width * img_height)
...
class CVAEGANMonitor(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for i in range(self.num_img):
            ...
            img.save("./generated/cvaegan/cvaegan_tha/generated_img_%03d_%d.png" % (epoch, i))
...
generator.save('./checkpoints/cvaegan_tha_generator_keras_model_nlatent_{}_batchsize_{}.hdf5'.format(n_latent,
                                                                                                    BATCH_SIZE))
...
for i in range(n_classes):
    np.save("./generated/cvaegan/cvaegan_tha_npy/generated_spectrogram_class_" + str(i) + ".npy",
